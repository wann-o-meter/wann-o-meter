...
class ExtractionResult:
    subject: dict[str, Any]  # slug, name, category - name is only used
    ...
    file_path: Path  # e.g. data/urlaubsfenster/bw.yaml - often
    ...
    source: dict[str, Any]  # Source shape: url, license, extraction, ...
    ...
    def __post_init__(self) -> None:
        ...
        an adapter already builds source["url"] once per run, so requiring
